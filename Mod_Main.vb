    ...
    Sub Main()
        ...
        Try
            ...
            If Date.Now.Hour = 7 And Date.Now.Minute = 10 Then 'se ejecutan una sola ves al dia a las 6 am
                ...
                EnviaCorreoLINEAS_CRED("LINEA_VENCIDA", 0, 0, "FACTORAJE")
                EnviaCorreoLINEAS_CRED("FECHA_REVISION", 1, 0, "FACTORAJE")
                EnviaCorreoLINEAS_CRED("FECHA_REVISION", 1, 1, "FACTORAJE")
                EnviaCorreoLINEAS_CRED("FECHA_REVISION", 1, 2, "FACTORAJE")
                EnviaCorreoLINEAS_CRED("FECHA_REVISION", 1, 3, "FACTORAJE")
                EnviaCorreoLINEAS_CRED("CONTRATO_VENCIDO", 0, 0, "FACTORAJE")

                EnviaCorreoLINEAS_CRED("NO_DISPUESTO", 1, 0, "CC")
                EnviaCorreoLINEAS_CRED("LINEA_VENCIDA", 0, 0, "CC")
                EnviaCorreoLINEAS_CRED("FECHA_REVISION", 1, 0, "CC")
                EnviaCorreoLINEAS_CRED("FECHA_REVISION", 2, 0, "CC")
                EnviaCorreoLINEAS_CRED("FECHA_REVISION", 3, 0, "CC")
                EnviaCorreoLINEAS_CRED("FECHA_REVISION", 1, 1, "CC")
                EnviaCorreoLINEAS_CRED("FECHA_REVISION", 2, 1, "CC")
                EnviaCorreoLINEAS_CRED("FECHA_REVISION", 3, 1, "CC")
                EnviaCorreoLINEAS_CRED("FECHA_REVISION", 1, 2, "CC")
                EnviaCorreoLINEAS_CRED("FECHA_REVISION", 2, 2, "CC")
                EnviaCorreoLINEAS_CRED("FECHA_REVISION", 3, 2, "CC")
                EnviaCorreoLINEAS_CRED("FECHA_REVISION", 1, 3, "CC")
                EnviaCorreoLINEAS_CRED("FECHA_REVISION", 2, 3, "CC")
                EnviaCorreoLINEAS_CRED("FECHA_REVISION", 3, 3, "CC")
                EnviaCorreoLINEAS_CRED("CONTRATO_VENCIDO", 0, 0, "CC")
            End If
